...
(function () {
    ...
    var main = function(){
        ...
        bounds = project.view.bounds;
        mover = new Mover(bounds);
        mover.velocity = Utils.randomPoint(3);
        mover.location = Utils.randomPointInBounds(bounds);

        var c = new Path.Circle(mover.location, 1);
        c.fillColor = "white";
        mover.circle = c;
        ...
        for(var i = 0; i < 5; i++) {
            ...
            follower.attractionCoefficient = 0.1;

            var p = new Path();
            p.strokeColor = "white";
            p.add(follower.location);
        ...
        //var c2 = new Path.Circle(follower.location, 5);
    ...
    var onFrame = function(event) {
        ...
        mover.circle.position = mover.location;
    };
